...
public class Chip8
{
    ...
    {
        return (byte)_random.Next(0xFF);
    }
    
    public bool ShouldPlaySound { get; set; }

    public bool HasColor(int i)
    {
        return Video[i] == 0x0;
    }
    ...
    public bool IsOn()
    {
        return PC <= ProgramSize && State is Chip8State.Running or Chip8State.Paused;
    }

    public bool IsRunning()
    {
        return State == Chip8State.Running;
    }

    public bool IsPaused()
    {
        return State == Chip8State.Paused;
    }

    public bool IsOff()
    {
        return State == Chip8State.Off;
    }
