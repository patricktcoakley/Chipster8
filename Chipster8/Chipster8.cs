...
public class Chipster8 : Game
{
    ...
    {
        get => _speed;
        set => _speed = Math.Clamp(value, (byte)0, (byte)10);
    }

    private int CurrentRom
    {
        get => _currentRom;
        set => _currentRom = Math.Clamp(value, 0, _romTitles.Count - 1);
    }
    ...
    {
        _canvas = new Texture2D(GraphicsDevice, Chip8.VideoWidth, Chip8.VideoHeight, true, SurfaceFormat.Color);
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        if (_chip8.IsOn())
        {
            ...
            for (var i = 0; i < _chip8.Keypad.Length; ++i) _chip8.Keypad[i] = false;
        }
